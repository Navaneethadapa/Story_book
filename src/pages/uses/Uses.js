  ...
  return (
    <Fragment>
      ...
      <ProjectContainer className={styles.uses}>
        ...
        <ProjectHeader
          title="Uses"
          description="A somewhat comprehensive list of tools, apps, hardware, and more that I use on a daily basis to design and code things. And yeah, that is a WEEKND GIF in the background😅."
        />
            ...
            <ProjectTextRow width="m">
              ...
              <ProjectSectionText as="div">
                <List>
                  ...
                  <ListItem>
                    <Link href="https://nextjs.org/">Next</Link> is another front end
                    Javascript library of my choice.
                  </ListItem>
                  <ListItem>
